...
/**
 * ArrayComponentTypeTransformer resolves the component type of an array type.
 *
...
final class ArrayComponentTypeTransformer extends ClassTransformerBase<Class> {
    ...
    protected Class doTypedTransform(Class input) {
        if(! input.isArray())
            return null;
        return resolveComponentType(input);
    }

    private static Class resolveComponentType(Class input) {
