...
/**
 * Executes {@link java.lang.reflect.Method#getDeclaredAnnotations()}.
 */
final class MethodDeclaredAnnotationsTransformer extends MethodListTransformerBase<Annotation> {
    @Override
