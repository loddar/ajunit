...
/**
 * JoinPointMatchers provides factory methods for {@link org.failearly.ajunit.internal.universe.AjJoinPointMatcher}.
 *
...
public abstract class JoinPointMatchers {
    ...
    public static AjJoinPointMatcher fieldMatcher(AjJoinPointType joinPointType) {
        return new FieldJoinPointMatcher(joinPointType);
    }

    public static AjJoinPointMatcher nullMatcher() {
        return NULL_MATCHER;
    }
}
