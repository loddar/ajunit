...
/**
 * Executes {@link java.lang.reflect.Member#getModifiers()}.
 */
final class MemberModifiersTransformer extends TypedTransformer<Member,Integer> {
    protected MemberModifiersTransformer() {
        super(Member.class);
    }
