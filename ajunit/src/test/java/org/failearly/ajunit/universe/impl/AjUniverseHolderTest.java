...
/**
 * AjUniverseHolderTest contains tests for {@link org.failearly.ajunit.universe.impl.AjUniversesHolder}.
 */
public class AjUniverseHolderTest {
    ...
    public void createAjUniverseByClassNames() throws Exception {
        ...
        final AjUniverse universe = AjUniversesHolder.createUniverseByClassNames(
                universeName,
                Arrays.asList("org.failearly.ajunit.universe.standard.AjUniverseHolderTest"));
